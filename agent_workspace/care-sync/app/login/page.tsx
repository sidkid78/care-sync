    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--clay-50)] p-4">
        <div className="card-warm p-8 max-w-sm w-full text-center space-y-4">
          ...
          <h2 className="text-xl font-semibold text-[var(--clay-900)]">Check your email</h2>
          <p className="text-sm text-[var(--clay-500)]">
            We sent a magic link to <span className="font-medium text-[var(--clay-700)]">{email}</span>.
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--clay-50)] p-4">
      <div className="card-warm p-8 max-w-sm w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-semibold text-[var(--clay-900)]">Welcome back</h1>
          <p className="text-sm text-[var(--clay-400)]">Sign in to Care-Sync</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full text-center text-sm text-[var(--sage-600)] hover:text-[var(--sage-700)] font-medium"
        >
